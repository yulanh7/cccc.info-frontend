...
export default function MessagesPage() {
  ...
  return (
    <div className="container mx-auto p-4 mt-0">
      <div className='flex justify-end mb-2 md:mb-10'>
        <PlusCircleIcon className="h-8 w-8 text-green" onClick={() => setIsNewChatOpen(true)} />
      </div>
          ...
          <li key={message.id} className='md:border-t-1 border-border'>
            ...
            >
              <div className="flex items-center">
                <UserCircleIcon className="h-6 w-6 text-dark-gray mr-3" />
