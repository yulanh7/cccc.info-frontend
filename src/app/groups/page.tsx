...
export default function GroupsPage() {
  ...
  const isUserSubscribed = (g: GroupProps) => !!membershipMap[g.id] || g.subscribed;
      ...
      <div className="mx-auto w-full p-4 min-h-screen lg:container">
        ...
        <div className="md:hidden space-y-4">
          {mobileRows.map((group) => {
            const subbed = isUserSubscribed(group);
            return (
              <div className={`card p-3 ${group.inviteOnly ? 'backdrop-blur-sm bg-opacity-80' : ''}`} key={group.id}>
